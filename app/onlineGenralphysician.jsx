  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Image
          source={require('@/assets/images/general physician icon 2.png')} // Replace with a heart icon URL
          style={styles.icon}
        />
        <Text style={styles.title}>Consulting a General Physician</Text>
      </View>
      {/* Language Options */}
...
export default OnlineGenralphysican;
