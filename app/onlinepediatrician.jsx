  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Image
          source={require('@/assets/images/Paediatrician.jpg')} // Replace with a heart icon URL
          style={styles.icon}
        />
        <Text style={styles.title}>Consulting a Pediatrician</Text>
      </View>
      {/* Language Options */}
...
export default OnlinePediatrician;
