  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Image
          source={require('@/assets/images/physiotherapisticon.png')} // Replace with a heart icon URL
          style={styles.icon}
        />
        <Text style={styles.title}>Consulting a Physiotherapist</Text>
      </View>
      {/* Language Options */}
...
export default Onlinephysiotherapist;
