  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Image
          source={require('@/assets/images/orthopedic icon 3.webp')} // Replace with a heart icon URL
          style={styles.icon}
        />
        <Text style={styles.title}>Consulting a Orthopedist</Text>
      </View>
      {/* Language Options */}
...
export default OnlineOrthopedist;
