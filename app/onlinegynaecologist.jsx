  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Image
          source={require('@/assets/images/gynecologist icon.jpeg.jpg')} // Replace with a heart icon URL
          style={styles.icon}
        />
        <Text style={styles.title}>Consulting a Gynacologist</Text>
      </View>
      {/* Language Options */}
...
export default OnlineGynaecologist;
