  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Image
          source={require('@/assets/images/Gastroenterologist icon 1.png')} // Replace with a heart icon URL
          style={styles.icon}
        />
        <Text style={styles.title}>Consulting a Gastrologist</Text>
      </View>
      {/* Language Options */}
...
export default Onlinegastrologist;
