  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Image
          source={require('@/assets/images/dermatologist icon 3.png')} // Replace with a heart icon URL
          style={styles.icon}
        />
        <Text style={styles.title}>Consulting a Dermatologist</Text>
      </View>
      {/* Language Options */}
...
export default Onlinedermatologist;
