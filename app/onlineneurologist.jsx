  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.titleContainer}>
        <Image
          source={require('@/assets/images/neurologist icon 02.png')} // Replace with a heart icon URL
          style={styles.icon}
        />
        <Text style={styles.title}>Consulting a Neurologist</Text>
      </View>
      {/* Language Options */}
...
export default OnlineNeurologist;
