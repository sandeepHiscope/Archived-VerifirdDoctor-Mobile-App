...
import { View, Text, StyleSheet, TextInput, FlatList, TouchableOpacity, Image,Link } from 'react-native';

const data = [
  {
    id: '1',
    name: 'Dr. G. Durga Rao',
    specialization: 'Pulmnologist',
...
export default function Pulmnologist() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.searchContainer}>
        <TextInput style={styles.searchInput} placeholder="Pulmnologist" />
